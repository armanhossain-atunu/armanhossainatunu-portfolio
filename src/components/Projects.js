  ...
  const projects = [
    {
      ...
      gitHubLink:
        "https://github.com/armanhossainatunu/Digital-Life-Lessons-cline",
      technologies: [
        {
          name: "React",
          color:
    ...
    },
    {
      ...
      description:
        "FinEase is a modern Personal Finance Management App that allows users to manage their income, expenses, balance, reports, and transaction history efficiently and in one place.",
      image: "https://i.ibb.co/4ZjDF4Q4/finease.png",
      liveLink: "https://fineaseappbd.netlify.app",
      gitHubLink: "https://github.com/armanhossainatunu/finEase-client-side",
      technologies: [
        {
          name: "React",
          color:
    ...
    },
    {
      ...
      description:
        "Warmpaws Pet Care is a trusted pet care service dedicated to keeping pets healthy, happy, and comfortable through compassionate care, grooming, and wellness support. 🐾",
      image: "https://i.ibb.co/0yy2RnCN/Screenshot-2026-01-05-131152.png",
      liveLink: "https://warmpaws-pet-care-service.netlify.app",
      gitHubLink: "https://github.com/armanhossainatunu/Warmpaws",
      technologies: [
        {
          name: "HTML5",
          color:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div variants={fadeInUp} className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
            A selection of my favorite works. Each project reflects my passion
            for creating intuitive and dynamic user experiences.
          </p>
        </motion.div>
