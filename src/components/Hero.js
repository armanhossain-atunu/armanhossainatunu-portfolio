...
=======
    {
      href: "https://github.com/armanhossainatunu",
      icon: "fab fa-github",
      hoverColor: "hover:bg-primary",
    },
    {
      href: "https://www.linkedin.com/in/armanhossainatunu",
      icon: "fab fa-linkedin-in",
      hoverColor: "hover:bg-blue-600",
    },
    {
      href: "https://www.instagram.com/armanhossainatunu",
      icon: "fab fa-instagram",
      hoverColor: "hover:bg-pink-500",
    },
    {
      href: "mailto:armanhossainatunu@gmail.com?subject=Hello%20from%20Portfolio",
      icon: "fas fa-envelope",
      hoverColor: "hover:bg-red-500",
    },
>>>>>>> c91341c (fix: update portfolio and remove env/build from tracking)
  ];
  ...
  const floatingIcons = [
    {
      icon: "fab fa-react",
      color: "text-cyan-400",
      position: "absolute -bottom-4 right-10 z-20 animate-float-delayed",
      size: "w-14 h-14 sm:w-16 sm:h-16",
      borderColor: "border-cyan-500/30",
      shadowColor: "shadow-[0_0_15px_rgba(6,182,212,0.5)]",
      extraClass: "animate-spin-slow",
      style: { animationDuration: "10s" },
    },
    {
      icon: "fab fa-js",
      color: "text-yellow-400",
      position: "absolute top-10 -left-4 z-20 animate-float",
      size: "w-12 h-12 sm:w-14 sm:h-14",
      borderColor: "border-yellow-500/30",
      shadowColor: "shadow-[0_0_15px_rgba(234,179,8,0.5)]",
    },
    {
      icon: "fab fa-html5",
      color: "text-orange-500",
      position: "absolute top-0 right-10 z-20 animate-float-slow",
      size: "w-12 h-12 sm:w-14 sm:h-14",
    ...
    },
    {
      ...
      position: "absolute bottom-10 -left-2 z-20 animate-float-delayed",
      size: "w-10 h-10 sm:w-12 sm:h-12",
      borderColor: "border-green-500/30",
      shadowColor: "shadow-[0_0_15px_rgba(34,197,94,0.5)]",
    },
  ];

  return (
    <main
      className="relative z-10 pt-20 min-h-screen flex items-center justify-center"
      id="home"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              ...
              passion and precision. Transforming ideas into seamless digital
              experiences.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <span className="relative flex items-center gap-2">
                  Download Resume
                  <span className="material-icons-outlined text-sm animate-bounce">
                    download
                  </span>
                </span>
              </motion.a>
          ...
          >
            <div className="relative w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[450px] lg:h-[450px]">
              ...
              {floatingIcons.map((iconData, index) => (
                ...
                >
                  <div
                    className={`${iconData.size} rounded-full bg-gray-900 border ${iconData.borderColor} flex items-center justify-center ${iconData.shadowColor} backdrop-blur-sm`}
                  >
                    <i
